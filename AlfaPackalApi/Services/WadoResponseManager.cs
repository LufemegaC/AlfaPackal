...
{
    public class WadoResponseManager
    {
        #region consts
        ...
        // <summary>
        /// string representation of the dicom metadata type
        /// </summary>
        private const string AppDicomMetadataType = "application/dicom+json";

        // <summary>
        /// string representation of the object pair
        /// </summary>
        private const string AppMultipartType = "multipart/form-data";
