...
namespace Api_PACsServer.Migrations
{
    ...
    [Migration("20241226215442_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api_PACsServer.Models.AccessControl.LocalDicomServer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.AccessControl.SystemUser", b =>
                {
            ...
            modelBuilder.Entity("Api_PACsServer.Models.DicomSupport.StudyModality", b =>
                {
                    ...
                    b.ToTable("StudyModalities");
                });

            modelBuilder.Entity("Api_PACsServer.Models.Geography.City", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Geography.State", b =>
                {
                    b.Property<string>("ID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Instance", b =>
                {
                    ...
                    b.Property<string>("InstanceCreationDate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("InstanceCreationTime")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<float>("SliceLocation")
                        .HasColumnType("real");

                    b.Property<float>("SliceThickness")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Serie", b =>
                {
                    b.Property<string>("SeriesInstanceUID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Study", b =>
                {
                    b.Property<string>("StudyInstanceUID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Supplement.InstanceDetails", b =>
                {
                    b.Property<string>("SOPInstanceUID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Supplement.SerieDetails", b =>
                {
                    b.Property<string>("SeriesInstanceUID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("SerieDetails");
                });

            modelBuilder.Entity("Api_PACsServer.Models.Supplement.StudyDetails", b =>
                {
                    b.Property<string>("StudyInstanceUID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Api_PACsServer.Models.DicomSupport.StudyModality", b =>
                {
                    b.HasOne("Api_PACsServer.Models.Study", "Study")
                        .WithMany("ModalitiesInStudy")
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Geography.City", b =>
                {
                    b.HasOne("Api_PACsServer.Models.Geography.State", "State")
                        .WithMany()
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Instance", b =>
                {
                    b.HasOne("Api_PACsServer.Models.Serie", "Serie")
                        .WithMany("Instances")
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Supplement.InstanceDetails", b =>
                {
                    b.HasOne("Api_PACsServer.Models.Instance", "Instance")
                        .WithOne("InstanceDetails")
                        .HasForeignKey("Api_PACsServer.Models.Supplement.InstanceDetails", "SOPInstanceUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Supplement.SerieDetails", b =>
                {
                    b.HasOne("Api_PACsServer.Models.Serie", "Serie")
                        ...
                        .HasForeignKey("Api_PACsServer.Models.Supplement.SerieDetails", "SeriesInstanceUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Supplement.StudyDetails", b =>
                {
                    b.HasOne("Api_PACsServer.Models.Study", "Study")
                        ...
                        .HasForeignKey("Api_PACsServer.Models.Supplement.StudyDetails", "StudyInstanceUID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Api_PACsServer.Models.AccessControl.SystemUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Api_PACsServer.Models.Study", b =>
                {
                    b.Navigation("ModalitiesInStudy");
