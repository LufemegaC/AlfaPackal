...
namespace Api_PACsServer.Migrations
{
    ...
    [Migration("20240902214805_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api_PACsServer.Modelos.Instance", b =>
                {
                    ...
                    b.HasKey("StudyID", "SeriesNumber", "InstanceNumber");

                    b.HasIndex("SOPInstanceUID")
                        .HasDatabaseName("IX_Instance_SOPInstanceUID");
            ...
            modelBuilder.Entity("Api_PACsServer.Modelos.Load.InstanceDetails", b =>
                {
                    b.Property<string>("InstanceDetailsId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("InstanceDetailsId");

                    b.HasIndex("StudyID", "SeriesNumber", "ImageNumber");

                    b.ToTable("InstancesLoad");
                });

            modelBuilder.Entity("Api_PACsServer.Modelos.Load.SerieDetails", b =>
                {
                    b.Property<string>("SerieDetailsId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("SerieDetailsId");

                    b.HasIndex("StudyID", "SeriesNumber");

                    b.ToTable("SeriesLoad");
                });

            modelBuilder.Entity("Api_PACsServer.Modelos.Load.StudyDetails", b =>
                {
                    b.Property<string>("StudyDetailsID")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("StudyDetailsID");

                    b.HasIndex("StudyID");

                    b.ToTable("StudiesLoad");
                });
            ...
            modelBuilder.Entity("Api_PACsServer.Modelos.Study", b =>
                {
                    ...
                    b.HasIndex("StudyInstanceUID")
                        .HasDatabaseName("IX_Study_StudyInstanceUID");
            ...
            modelBuilder.Entity("Api_PACsServer.Modelos.Instance", b =>
                {
                    b.HasOne("AlfaPackalApi.Modelos.Serie", "Serie")
                        .WithMany("Instances")
                        .HasForeignKey("StudyID", "SeriesNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Api_PACsServer.Modelos.Load.InstanceDetails", b =>
                {
                    b.HasOne("Api_PACsServer.Modelos.Instance", "Instance")
                        .WithMany()
                        .HasForeignKey("StudyID", "SeriesNumber", "ImageNumber")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
