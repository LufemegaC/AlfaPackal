...
namespace InterfazBasica_DCStore.Service.DicomServices
{
    public class DicomOrchestrator : IDicomOrchestrator
    {
        ...
        public async Task<DicomStatus> StoreDicomData(DicomFile dicomFile)
        {
            ...
            // 12/07/24 LFMG: Reemplazo por solo una imagenCreate
            ...
            imageCreateDto.ExistStudy = mainDicomValues.ExistStudy;
            ...
            else
            {
                ...
                estudioCreateDto.InstitutionId = ServerInfo.InstitutionId; // from Server
                //Asignacion de ruta:
        ...
        public async Task<DicomStatus> StoreDicomFile(DicomFile dicomFile)
        {
            ...
            var mainDicomValues = ExtractMainValues(dicomFile.Dataset);
            var filePath = RootFileDicomConstructor(mainDicomValues.StudyInstanceUID, mainDicomValues.SeriesInstanceUID, mainDicomValues.StudyInstanceUID);
